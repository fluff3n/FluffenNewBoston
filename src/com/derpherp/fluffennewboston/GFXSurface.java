...
public class GFXSurface extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ourSurfaceView = new FluffenSurface(this);
		...
		test = BitmapFactory.decodeResource(getResources(), R.drawable.bluesquare); 
	...
	public class FluffenSurface extends SurfaceView implements Runnable {

		SurfaceHolder ourHolder;
		Thread ourThread = null;
		boolean isRunning = false;

		public FluffenSurface(Context context) {
